...
public class AlgaMediaTypes {
    ...
    public static final String V1_APPLICATION_JSON_VALUE = "application/vnd.algafoofd.v1+json";
    
    public static final MediaType V1_APPLICATION_JSON = MediaType.valueOf(V1_APPLICATION_JSON_VALUE);

    public static final String V2_APPLICATION_JSON_VALUE = "application/vnd.algafoofd.v2+json";
